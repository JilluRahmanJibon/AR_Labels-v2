		...
		<section className="py-6 md:py-12 bg-white">
			<div className="container mx-auto flex flex-col md:flex-row items-center justify-center px-4 md:px-0">
				...
				<motion.div
					...
					whileInView={{ opacity: 1, x: 0 }} // Trigger animation every time it enters the viewport
					transition={{ duration: 0.8 }}
					whileHover={{ scale: 1.1 }}
					viewport={{ once: false }} // Ensure animation triggers every time
					className="sm:w-[400px] w-[300px] max-h-[400px] flex-shrink-0 overflow-hidden rounded-lg">
					<motion.img
				...
				<motion.div
					...
					whileInView={{ opacity: 1, y: 0 }} // Trigger animation every time it enters the viewport
					transition={{ duration: 0.8, delay: 0.3 }}
					viewport={{ once: false }} // Ensure animation triggers every time
					className="md:w-1/2 md:mt-0 mt-4 p-4 md:text-left text-center GeologicaFont leading-snug text-gray-700">
